...
class Ui_window5(object):
    def setupUi(self, window5):
        ...
        window5.setWindowIcon(QtGui.QIcon('icons/logo.ico'))
        ...
        self.label_6.setObjectName("Arial Black")
    ...
    def retranslateUi(self, window5):
        ...
        window5.setWindowTitle(_translate("window5", "TIMECRAFT"))
        ...
        item.setText(_translate("window3", "9:30-10:30"))
        item = self.generated_table.horizontalHeaderItem(1)
        item.setText(_translate("window3", "10:30-11:30"))
        item = self.generated_table.horizontalHeaderItem(2)
        item.setText(_translate("window3", "BREAK"))
        item = self.generated_table.horizontalHeaderItem(3)
        item.setText(_translate("window3", "11:45-12:45"))
        item = self.generated_table.horizontalHeaderItem(4)
        item.setText(_translate("window3", "LUNCH-BREAk"))
        item = self.generated_table.horizontalHeaderItem(5)
        item.setText(_translate("window3", "2:00-2:40"))
        ...
        self.label.setText(_translate("window5", "TimeCraft Generation"))
