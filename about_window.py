...
class Ui_aboutWindow(object):
    def setupUi(self, aboutWindow):
        ...
        aboutWindow.setStyleSheet(lightstyle.css.replace('logo.png', 'img14.jpg'))
        aboutWindow.setWindowIcon(QtGui.QIcon('icons/logo.png'))
        ...
        aboutWindow.setMinimumSize(QtCore.QSize(900, 500))
        aboutWindow.setMaximumSize(QtCore.QSize(900, 500))
        self.gridLayoutWidget = QtWidgets.QWidget(aboutWindow)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 901, 491))
    ...
    def retranslateUi(self, aboutWindow):
        ...
        self.label.setText(_translate("aboutWindow", "TIMECRAFT"))
        self.label_2.setText(_translate("aboutWindow", "A Final Year BCA Mini Project By \n "
"Arun LR\n"
"Neelanjan V\n"
"Shashanka\n"
"Vinod Moger\n"
"\n"
 "  Udupi College of Professional Studies,Manipal  "))
